...
inline unsigned char ExtractByte(unsigned int ui)
{
...
{
	return ((m_auiS[0][ExtractByte(ui>>24)] + m_auiS[1][ExtractByte(ui>>16)]) ^ m_auiS[2][ExtractByte(ui>>8)]) + m_auiS[3][ExtractByte(ui)];
}
